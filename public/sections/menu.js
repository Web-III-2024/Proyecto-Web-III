  ...
  updateUserEmailDisplay() {
    ...
    auth.onAuthStateChanged((user) => {
      ...
      if (user) {
        ...
        // Ocultar la imagen del usuario y el correo electrónico
        userInfoDiv.style.display = "none";
        // Mostrar las acciones de usuario (acceder)
        const userActions = this.querySelector("#user-actions");
